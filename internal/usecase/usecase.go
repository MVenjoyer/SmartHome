...
type EventRepository interface {
	...
	// GetSensorHistory - функция получения истории датчика с ID во временном отрезке [start_date, end_date]
	GetSensorHistory(ctx context.Context, id int64, startDate, endDate time.Time) ([]domain.Event, error)
}
