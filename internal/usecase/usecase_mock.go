...
func (m *MockEventRepository) GetSensorHistory(ctx context.Context, id int64, startDate, endDate time.Time) ([]domain.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSensorHistory", ctx, id, startDate, endDate)
	ret0, _ := ret[0].([]domain.Event)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEventRepositoryMockRecorder) GetSensorHistory(ctx, id, startDate, endDate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSensorHistory", reflect.TypeOf((*MockEventRepository)(nil).GetSensorHistory), ctx, id, startDate, endDate)
}
